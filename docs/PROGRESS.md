...
1. Finish step 8: `ui-web` and `ui-native` buttons, merchant-portal and admin (Vite), customer-web (Next.js), merchant-app (Expo), then `pnpm dev` and `pnpm build` across everything.
